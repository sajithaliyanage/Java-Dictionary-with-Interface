...
public class FileReadInputs {
    ...
    public BinaryTree readInputs() {
        ...
        try {
            ...
            read = new FileReader("dictionary\\inputs.txt");
    ...
    public void removeInputs() {
        try {
            FileWriter fwOb = new FileWriter("dictionary\\inputs.txt", false);
        ...
        while (nodeStack.empty() == false) {
            ...
            try {
                writer = new BufferedWriter(new OutputStreamWriter(
                        new FileOutputStream("dictionary\\inputs.txt"), "utf-8"));
    ...
    public void appendWords(String data) {
        ...
        try (FileWriter fw = new FileWriter("dictionary\\inputs.txt", true);
